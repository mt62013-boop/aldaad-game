...
function buildExpandedExplanation(question) {
  ...
  if (/(استعارة|كناية|تشبيه|الصورة الفنية|الصورة البيانية|النداء|الاستفهام|النهي|التمني|الأسلوب البلاغي|الغرض البلاغي)/.test(prompt)) {
    return "في أسئلة التذوق الفني والبلاغة ركّز على أثر التعبير في المعنى والفكر والعاطفة وتوصيل الرسالة إلى المتلقي، لا على تسمية النوع فقط. وفي الكناية يمكن ذكر نوعها مع شرح الأثر والمعنى المستفاد من سياق النص.";
  }
...
function generateSmartHint(question) {
  ...
  if (/(استعارة|كناية|تشبيه|الصورة الفنية|الصورة البيانية|النداء|الاستفهام|النهي|التمني|الأسلوب البلاغي|الغرض البلاغي)/.test(prompt)) {
    hints.push("اسأل نفسك: ما المعنى الذي أكده التعبير؟ وكيف أثر في الفكرة أو العاطفة أو وضوح الرسالة عند المتلقي؟");
  }
