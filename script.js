...
function buildExpandedExplanation(question) {
  ...
  if (/إذا|إن\s*\+|قد\s*\+/.test(prompt)) {
    return "من دلالات الحروف: إذا مع الماضي تفيد تحقق ما بعدها، وإن مع الفعل قد تفيد الشك، وقد مع الماضي للتحقيق، ومع المضارع تتحدد دلالتها بالسياق.";
  }
...
function generateSmartHint(question) {
  ...
  if (/إذا|إن\s*\+|قد\s*\+/.test(prompt)) {
    hints.push("راجع دلالة الحرف في السياق: إذا، إن، وقد؛ فلكل منها أثر معنوي خاص.");
  }
