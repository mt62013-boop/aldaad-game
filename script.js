...
const DEFAULT_QUESTION_BANK = [
  ...
  },
  {
    ...
    options: ["الإسلامُ دينُ فاعليةٍ وإصلاحٍ ومحاربةٍ للتخاذل.", "الدرس يقتصر على شرح مفردات معزولة", "الغاية من الدرس تمجيد الصمت", "الدرس يدعو إلى ترك الشأن العام"],
    correctIndex: 0,
    explanation: "التلخيص الصحيح يأتي في جملة اسمية عامة تجمع الفكرة الرئيسة والقيمة التربوية في النص."
  },
  {
    category: "الثروة اللغوية",
  ...
  {
    category: "الفهم والاستيعاب",
    prompt: "ما الأثر الذي يتركه الحسن في الكون كما يفهم من مطلع (الوحي الخالد)؟",
    options: ["يبعث البهجة ويوقظ الوجدان ويجلو مظاهر الطبيعة", "يزرع الكآبة ويطفئ الإحساس بالجمال", "يدفع الشاعر إلى هجر الطبيعة والفرار منها", "يحصر الشعور الإنساني في الألم وحده"],
    correctIndex: 0,
    explanation: "يصور مطلع القصيدة أن الحسن يفيض على الكون بهجةً ويستثير نفس الشاعر إلى التأمل والانبهار."
  },
  {
    category: "الفهم والاستيعاب",
  ...
  },
  {
    ...
    options: ["الجمالُ ذو أثرٍ عظيمٍ في الكون والطبيعة.", "التشاؤم من تقلبات الحياة", "الدعوة إلى العزلة", "مدح المال والثراء"],
    correctIndex: 0,
    explanation: "الإجابة الصحيحة صيغت جملة اسمية؛ لأنها تعبّر عن الفكرة العامة الجزئية للأبيات الأولى بوضوح."
  },
  {
    category: "الفهم والاستيعاب",
    prompt: "إلى ماذا يدعو الشاعر في الأبيات الأخيرة من (الوحي الخالد)؟",
    options: ["الدعوة إلى الاستمتاع بالجمال ما دام متاحًا.", "ترك التأمل في الطبيعة", "نسيان الربيع تمامًا", "الابتعاد عن الفن"],
    correctIndex: 0,
    explanation: "في أسئلة الهدف أو الدعوة يُستحسن أن تبدأ الإجابة بعبارة مثل: الدعوة إلى، وهنا المقصود اغتنام الجمال قبل زواله."
  },
  {
    category: "فنون البلاغة",
    prompt: "ما أثر الصورة الفنية في قول الشاعر: (وتنثر الأزهار من عذباتها)؟",
    options: ["إبراز الطبيعة حيةً متحركةً تفيض جمالًا وعطرًا", "إثبات أن الأزهار ذابلة لا أثر لها", "تصوير الربيع في صورة حرب عنيفة", "حصر الجمال في مشهد واحد جامد"],
    correctIndex: 0,
    explanation: "في هذه الصورة تشخيص للطبيعة وإحياء لعناصرها، مما يزيد الإحساس بالحسن والبهجة في القصيدة."
  },
  {
    category: "الثروة اللغوية",
  ...
  },
  {
    ...
    options: ["رضا داخلي ينشأ من الفكرة المتفائلة وحسن النظر إلى الحياة", "الغرور والتكبر على الناس", "الحزن الدائم الذي لا علاج له", "الاستسلام لليأس والشكوى المستمرة"],
    correctIndex: 0,
    explanation: "القصيدة تبين أن الغبطة ليست مظاهر خارجية، بل فكرة تولد الرضا والسرور من داخل النفس."
  },
  {
    category: "الفهم والاستيعاب",
