...
function buildExpandedExplanation(question) {
  ...
  if (/(استعارة|كناية|تشبيه|الصورة الفنية|الصورة البيانية)/.test(prompt)) {
    return "في الصورة الفنية لا تكتفِ بذكر النوع، بل بيّن أثرها في توضيح المعنى والفكر والعاطفة، وما الذي أضافته إلى رأي الكاتب أو الشاعر. وفي الكناية يمكن ذكر نوعها مع شرح الأثر والمعنى المستفاد من السياق.";
  }
...
function generateSmartHint(question) {
  ...
  if (/(استعارة|كناية|تشبيه|الصورة الفنية|الصورة البيانية)/.test(prompt)) {
    hints.push("اسأل نفسك: ماذا أضافت الصورة إلى المعنى؟ وكيف أثرت في العاطفة أو وضحت الفكرة للمتلقي؟");
  }
