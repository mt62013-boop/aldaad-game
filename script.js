...
const DEFAULT_QUESTION_BANK = [
  ...
  {
    category: "فنون البلاغة",
    prompt: "بمَ يوحي النداء في قوله تعالى: (يا عبادي الذين أسرفوا على أنفسهم)، وما أثره في النفس؟",
    options: ["بالتلطف والاستعطاف وفتح باب الرجاء أمام المذنبين", "بالإلزام الجاف والوعيد وحده", "بالإنكار والسخرية من حال العصاة", "بالقسوة وقطع الأمل من الرحمة"],
    correctIndex: 0,
    explanation: "جاء النداء بلفظ (يا عبادي) ليقرب المذنبين من رحمة الله، ويوقظ في نفوسهم الأمل والإنابة بدل اليأس."
  },
  {
    category: "فنون البلاغة",
    ...
    correctIndex: 0,
    explanation: "النهي هنا ليس لمجرد المنع، بل غرضه التحذير من اليأس وحث النفس على الرجوع إلى رحمة الله."
  },
  {
    category: "السلامة اللغوية",
  ...
  {
    category: "فنون البلاغة",
    prompt: "ما الذي يعبر عنه نداء الشاعر في قوله: (أيها العابس)؟",
    options: ["النصح والحث على البشاشة وترك العبوس", "التهكم الجارح والسخرية المجردة", "الخوف من مواجهة الناس", "الدعوة إلى الاستسلام للشكوى"],
    correctIndex: 0,
    explanation: "جاء النداء ليوقظ العابس من حاله، ويعبر عن رغبة الشاعر في إصلاح النفس ودفعها إلى التفاؤل والبشاشة."
  },
  {
    category: "الثروة اللغوية",
  ...
  },
  {
    lesson: "lesson5",
    category: "فنون البلاغة",
    prompt: "أي العبارات الآتية تشتمل على نداء غرضه النصح والحث على البشاشة؟",
    options: ["أيها العابس", "أقبل العيد ولكن ليس في الناس المسرة", "إنما الغبطة فكرة", "إن من يبكي له حول على الضحك وقدرة"],
    correctIndex: 0,
    explanation: "جاء النداء في (أيها العابس) للنصح والإيقاظ من العبوس، لا لمجرد التنبيه أو النداء العادي."
  },
  {
    lesson: "lesson1",
    category: "فنون البلاغة",
    prompt: "أي العبارات الآتية تشتمل على نداء غرضه التلطف والاستعطاف وفتح باب الرجاء؟",
    options: ["يا عبادي الذين أسرفوا على أنفسهم", "لا تقنطوا من رحمة الله", "لو أن الله هداني", "قد جاءتك آياتي"],
    correctIndex: 0,
    explanation: "هذه العبارة تشتمل على نداء يبعث الطمأنينة والرجاء، ويقرب المذنب من رحمة الله بدل أن يطرده منها."
  }
];
...
function buildExpandedExplanation(question) {
  ...
  if (/(استعارة|كناية|تشبيه|الصورة الفنية|الصورة البيانية|النداء|الاستفهام|النهي|الأمر|التمني|الأسلوب البلاغي|الغرض البلاغي)/.test(prompt)) {
