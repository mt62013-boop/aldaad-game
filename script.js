...
const DEFAULT_QUESTION_BANK = [
  ...
  {
    category: "الفهم والاستيعاب",
    prompt: "ما الفكرة التي تعبر عنها الأبيات من الأول إلى العاشر في قصيدة (الوحي الخالد)؟",
    options: ["الحسنُ يملأُ الطبيعةَ والكونَ حياةً وبهجةً، وتلتقي عناصرُهما للترحيب به.", "القبحُ يسيطرُ على الطبيعة منذ بداية القصيدة", "الشاعرُ يعرضُ شكوى اجتماعية بعيدة عن الجمال", "القصيدةُ تدعو إلى الانصراف عن التأمل في الكون"],
    correctIndex: 0,
    explanation: "هذه الأبيات تدور حول أثر الجمال في الطبيعة وصورها الزاهية، وكيف استجابت له عناصر الكون واستقبلته بالترحيب واللقاء."
  },
  {
    category: "الفهم والاستيعاب",
