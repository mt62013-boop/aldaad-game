...
function buildExpandedExplanation(question) {
  ...
  if (/محل الجملة|موقع الجملة|خبر إن|خبر المبتدأ|خبر كان|خبر الفعل الناسخ|جملة الحال|جملة النعت|جواب شرط|مفعولاً به|مفعول به ثان|بالإضافة|معطوفة/.test(prompt)) {
    return "في إعراب الجمل حدّد أولًا موقع الجملة: خبر، حال، نعت، مفعول به، جواب شرط، مضاف إليه، أو معطوفة. ثم استخرج محلها من الإعراب: الرفع في خبر المبتدأ وإن، والنصب في خبر الفعل الناسخ والحال والجملة الواقعة مفعولًا به، ويكون محل جملة النعت بحسب موقع المنعوت رفعًا أو نصبًا أو جرًّا، والجر إذا وقعت الجملة مضافًا إليه بعد الظرف، والجزم إذا وقعت جوابًا لشرط جازم مستوفيًا شروطه أو مقترنًا بالفاء في مواضعه المقررة.";
  }
...
function generateSmartHint(question) {
  ...
  if (/محل الجملة|موقع الجملة|خبر إن|خبر المبتدأ|خبر كان|خبر الفعل الناسخ|جملة الحال|جملة النعت|جواب شرط|مفعولاً به|مفعول به ثان|بالإضافة|معطوفة/.test(prompt)) {
    hints.push("حدّد موقع الجملة أولًا: خبر أم حال أم نعت أم مفعول به أم جواب شرط أم مضاف إليه أم معطوفة.");
    hints.push("بعد تحديد الموقع استخرج المحل: رفع أو نصب أو جر أو جزم بحسب القاعدة.");
  }
