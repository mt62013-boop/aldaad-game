...
const DEFAULT_QUESTION_BANK = [
  ...
  },
  {
    ...
    options: ["لأن الفرح ينبع من طريقة النظر إلى الحياة لا من المناسبة وحدها", "لأن السعادة لا تكون إلا بكثرة المال", "لأن العيد سبب كافٍ للفرح ولو كانت النفوس متعبة", "لأن الشاعر يرفض كل أنواع البهجة"],
    correctIndex: 0,
    explanation: "جوهر القصيدة أن السعادة الحقيقية تبدأ من الداخل ومن التفكير المتفائل، لا من الظروف الخارجية وحدها."
  },
  {
    lesson: "lesson5",
    category: "الفهم والاستيعاب",
    ...
    correctIndex: 0,
    explanation: "يرى الشاعر أن الحزن لا سببه العيد أو الناس، بل طريقة التفكير المستسلمة للعبوس والشكوى."
  },
  {
    lesson: "lesson5",
    category: "الثروة اللغوية",
